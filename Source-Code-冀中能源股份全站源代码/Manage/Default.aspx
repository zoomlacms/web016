<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.index, App_Web_bphj4s1i" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html lang="zh">
<head id="Head1" runat="server">
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
<title><%Call.Label("{$SiteName/}");%>--后台管理</title>
...
<%--        <div id="oDIV11" style="border: 1px solid #014995; background-color: #FFFFFF; width: 800px;
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="height: 24px; font-size: 12px">
                                                    ...
                                                    <input id="cu5" name="cUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="cu6" name="cUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="cu7" name="cUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="cu8" name="cUser" type="checkbox"  style="display:none;"checked="checked" />
                                                    <input id="cu9" name="cUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="cu10" name="cUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="cu11" name="cUser" type="checkbox"  style="display:none;"checked="checked" />
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tbody>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="height: 24px; font-size: 12px">
                                                    ...
                                                    <input id="su5" name="sUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="su6" name="sUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="su7" name="sUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="su8" name="sUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="su9" name="sUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="su10" name="sUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="su11" name="sUser" type="checkbox" style="display:none;" checked="checked" />
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tbody>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="height: 24px; font-size: 12px">
                                                    ...
                                                    <input id="pu5" name="pUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="pu6" name="pUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="pu7" name="pUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="pu8" name="pUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="pu9" name="pUser" type="checkbox" style="display:none;" checked="checked" />
                                                    &nbsp;&nbsp;<input id="pu10" name="pUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="pu11" name="pUser" type="checkbox" style="display:none;" checked="checked" />
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tbody>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="height: 24px; font-size: 12px">
                                                    ...
                                                    <input id="ou5" name="oUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="ou6" name="oUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="ou7" name="oUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="ou8" name="oUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="ou9" name="oUser" type="checkbox" style="display:none;" checked="checked" />
                                                    &nbsp;&nbsp;<input id="ou10" name="oUser" style="display:none;" type="checkbox" checked="checked" />
                                                    <input id="ou11" name="oUser" type="checkbox" style="display:none;" checked="checked" />
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tbody>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="height: 24px; font-size: 12px">
                                                    ...
                                                    <input id="ccu5" name="ccUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="ccu6" name="ccUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="ccu7" name="ccUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="ccu8" name="ccUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="ccu9" name="ccUser" type="checkbox" style="display:none;" checked="checked" />
                                                    &nbsp;&nbsp;<input id="ccu10" name="ccUser" style="display:none;" type="checkbox" checked="checked" />
                                                    <input id="ccu11" name="ccUser" type="checkbox" style="display:none;" checked="checked" />
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tbody>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="height: 24px; font-size: 12px">
                                                    ...
                                                    <input id="Sacu5" name="SacUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="Sacu6" name="SacUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="Sacu7" name="SacUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="Sacu8" name="SacUser" type="checkbox" style="display:none;" checked="checked" />
                                                    <input id="Sacu9" name="SacUser" type="checkbox"  style="display:none;"checked="checked" />
                                                    &nbsp;&nbsp;<input id="Sacu10" name="SacUser" style="display:none;" type="checkbox" checked="checked" />
                                                    <input id="Sacu11" name="SacUser" type="checkbox" style="display:none;" checked="checked" />
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tbody>
                ...
                <td colspan="3" valign="top" align="left">
                    <div id="Announce">
                        ...
                        <p>
                            ...
                            <a href="Site/SiteConfig.aspx" title="站群模式">站群模式</a>
                    ...
                    <div id="content" class="pos_relat">
                       <%if (ZoomLa.Components.SiteConfig.SiteOption.CloudLeadTips == "1")
                         {
          %> <span id="ball"><a href="javascript:ShowMain('Profile/QuickLinks.aspx','Template/CloudLead.aspx')"><%--云端推送--%><%=lang.Get("m_cloud")%></a><strong><a href="javascript:void(0)" onClick="setcloud('cloud','2','232');closeed()"  title="不再提示">×</a></strong></span>
          <% } %>
                            ...
                            <li id="Main_6" class="Main_1" onclick="ShowHideLayer(6,0)">
                                <%--企业黄页--%><%=lang.Get("m_YellowPage_enterprise")%></li>
                            <%} if (ShowForum == 1)
                              {%>
                    ...
                    search();//搜索事件 
                        ...
                        <div id="Menu_2" style="width: 100%; display: none;">
                            <ul>
                                ...
                                <%if (showContentArr[2].ToString() == "1")
                                  { %>
                                <li><a href="javascript:;"  onmouseover="showmenu(event,commentChild)">
                                ...
                                <li><a href="javascript:void(0);" onclick="ShowMain('Pub/PubGuide.aspx','Pub/pubmanage.aspx')"
                                    onmouseover="showmenu(event,'<div class=menuitems><a onclick=open_title(\'pub/pubinfo.aspx\',\'添加互动模块\') href=\'javascript:void(0)\' ><%=lang.Get("m_addinteractive") %></a></div><div class=menuitems><a onclick=open_title(\'pub/pubmanage.aspx\',\'互动模块管理\') href=\'javascript:void(0)\'><%=lang.Get("m_management") %></a></div><div class=menuitems><a onclick=open_title(\'pub/pubmanage.aspx\',\'互动信息管理\') href=\'javascript:void(0)\'><%=lang.Get("m_informmana") %></a></div><div class=menuitems><a onclick=open_title(\'Content/ModelManage.aspx?ModelType=7\',\'互动模型管理\') href=\'javascript:void(0)\'><%=lang.Get("m_modelmana") %></a></div><div class=menuitems><a onclick=open_title(\'pub/PubRecycler.aspx\',\'存档管理\') href=\'javascript:void(0)\'><%=lang.Get("m_archive") %></a></div>')">
                                    <%=lang.Get("m_interactive")%></a> </li>
                                <%
                                    }
                                  if (showContentArr[5].ToString() == "1")
                                  { %>
                                <li><a href="javascript:ShowMain('Content/CollectionGuide.aspx','Content/CollectionManage.aspx')"
                                    onmouseover="showmenu(event,'<div class=menuitems><a href=\'javascript:void(0)\' onclick=open_title(\'Content/CollectionManage.aspx\',\'采集项目管理\')><%--采集项目管理--%><%=lang.Get("m_acquproject") %></a></div><div class=menuitems><a href=\'javascript:void(0)\' onclick=open_title(\'Content/CollectionStep1.aspx\',\'添加采集项目\')><%--添加采集项目--%><%=lang.Get("m_addacquproject") %></a></div><div class=menuitems><a href=\'javascript:void(0)\' onclick=open_title(\'Content/CollectionStart.aspx\',\'开始采集\')><%--开始采集--%><%=lang.Get("m_began") %></a></div><div class=menuitems><a href=\'javascript:void(0)\'><%--采集进度--%><%=lang.Get("m_acquprogress") %></a></div><div class=menuitems><a href=\'javascript:void(0)\' onclick=open_title(\'Content/CollectionList.aspx\',\'采集历史记录\')><%--采集历史记录--%><%=lang.Get("m_acquhistory") %></a></div>')">
                                ...
                                <li><a href="javascript:ShowMain('Guest/BbsGuide.aspx','Guest/GuestCateMana.aspx')">
                                    <%--百科问答--%><%=lang.Get("m_mesmanage")%></a></li>
                                <%}
                            ...
                            <ul>
                                ...
                                <%}
                                    ...
                                    { %><li><a href="javascript:void(0);" onclick="ShowMain('User/MailGuide.aspx','User/RegValidateMail.aspx')"
                                        onmouseover="showmenu(event,'<div class=menuitems><a href=\'javascript:void(0)\' onclick=open_title(\'User/EidtMailModel.aspx\',\'邮件模版编辑\')><%= lang.Get("m_MailGuide_mailedite") %></a></div><div class=menuitems><a href=\'javascript:void(0)\' onclick=open_title(\'User/RegValidateMail.aspx\',\'邮件内容管理\')><%--邮件内容管理--%><%=lang.Get("m_mailcm") %></a></div><div class=menuitems><a href=\'javascript:void(0)\' onclick=open_title(\'User/SendMailList.aspx\',\'发送邮件管理\')><%--发送邮件管理--%><%=lang.Get("m_sende-mail") %></a></div><div class=menuitems><a href=\'javascript:void(0)\' onclick=open_title(\'User/MailListManage.aspx\',\'邮件列表管理\')><%--邮件列表管理--%><%=lang.Get("m_maillist") %></a></div><div class=menuitems><a href=\'javascript:void(0)\' onclick=open_title(\'User/SubscribeTypeList.aspx\',\'订阅管理\')><%--订阅管理--%><%=lang.Get("m_subemail") %></a></div><div class=menuitems><a href=\'javascript:void(0)\' onclick=open_title(\'User/AddMail.aspx\',\'邮件发送\')><%--邮件发送--%><%=lang.Get("m_mailsing") %></a></div><div class=menuitems><a href=\'javascript:ShowMain(\'User/MailIdiographList.aspx\',\'签名管理\')><%--签名管理--%><%=lang.Get("m_sigature") %></a></div>')">
                        ...
                        <div id="Menu_4" style="width: 100%; display: none;">
                            <ul>
                                ...
                                { %>
                                <li><a href="javascript:void(0);" onclick="ShowHideLayer(11,4)" onmouseover="showmenu(event,'<div class=menuitems><a href=javascript:void(0) onclick=open_title(\'UserShopManage/StoreManage.aspx\',\'店铺申请与审核\')><%= lang.Get("m_shopssetting") %></a></div><div class=menuitems><a href=javascript:void(0) onclick=open_title(\'UserShopManage/StoreStyleManage.aspx\',\'商家店铺模板管理\')><%= lang.Get("m_busintem") %></a></div><div class=menuitems><a href=javascript:void(0) onclick=open_title(\'UserShopManage/ProductManage.aspx\',\'商家商品管理\')><%= lang.Get("m_merchant") %></a></div><div class=menuitems><a href=javascript:void(0) onclick=open_title(\'Content/ModelManage.aspx?ModelType=5\',\'店铺模型管理\')><%= lang.Get("m_shopmodel") %></a></div><div class=menuitems><a href=javascript:void(0) onclick=open_title(\'UserShopManage/ShopinfoManage.aspx\',\'店铺配置\')><%= lang.Get("m_storeconfig") %></a></div>')"
                                    style="font-weight: bold">
                        ...
                        <div id="Menu_5" style="width: 100%; display: none;">
                            <ul>
                                ...
                                <li><a href="javascript:ShowMain('AddOn/StructGuide.aspx','AddOn/StructManage.aspx')">
                                    <%--组织结构--%><%=lang.Get("m_Structure")%></a></li>
                                <%} 
                                ...
                                <%}
                                   if (ShowBIArr[2].ToString() == "1")
                                  { %>
                                <li> <a href="javascript:ShowMain('User/CustomerGuide.aspx','iServer/BiServer.aspx?num=-3&strTitle=')"><%--有问必答--%><%=lang.Get("m_ServerSite_problem") %></a>
                                   <%-- <a href="javascript:ShowMain('AddCRM/Customer.aspx','AddCRM/CustomerList.aspx?usertype=0')">
                                   <%=lang.Get("m_crm")%></a>--%> <%--CRM管理--%></li>
                                <%}  
                        ...
                        <div id="Menu_9" style="width: 100%; display: none;">
                            <ul>
                                ...
                                <li><a href="javascript:ShowMain('AddOn/DataGuide.aspx','Config/DatalistProfile.aspx')">
                                    <%--开发中心--%><%=lang.Get("m_maintence")%></a></li>
                                     <%} 
                                ...
                                <li><a href="javascript:ShowMain('AddOn/DownGuide.aspx','AddOn/Download.aspx')">
                                    <%--客户端--%><%= lang.Get("m_ClientGuide") %></a></li>
                                <%} 
                                 if (ShowPlubArr[7].ToString() == "1")
                                  { %>
			                    <li><a href="javascript:ShowMain('WeiXin/wxApiGuide.aspx','WeiXin/wxApi.aspx')">
			                     <%--微信App--%><%= lang.Get("m_ClientWxApi") %></a></li>
                                     <%} 
                                   if (ShowPlubArr[8].ToString() == "1")
                                   { %>
                                <li><a href="javascript:void(0);" onclick="ShowMain('Pub/PubGuide.aspx','Pub/pubmanage.aspx')"
                                    onmouseover="showmenu(event,'<div class=menuitems><a href=\'javascript:void(0);\' onclick=ShowMain(\'Iplook/IplookGuide.aspx\',\'Iplook/IPManage.aspx\') ><%--IP识别系统--%><%=lang.Get("m_IPGuid_recsys") %></a></div><div class=menuitems><a href=\'javascript:void(0);\' onclick=ShowMain(\'Search/SearchGuide.aspx\',\'Search/DirectoryManage.aspx\')><%--全文检索--%><%=lang.Get("m_FullTextRetrieval") %></a></div><div class=menuitems><a href=\'javascript:void(0);\' onclick=ShowMain(\'AddOn/FileseeGuide.aspx\',\'AddOn/FileseeManage.aspx\')><%--文件比较--%><%=lang.Get("m_FileOnlineGuide_compare") %></a></div>')">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function setLayout() {
            ...
            {
                window.top.location='Mobile/Default.aspx';
            }
