<%@ page language="C#" autoeventwireup="true" inherits="manage_Plus_Author, App_Web_wvuebozl" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>添加作者</title>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" >
            <td class="tdbgleft">
                <strong>生日：</strong></td>
            <td>
             <input name="member.birth" class="l_input" id="tbUBday" runat="server" type="text" value="1982-1-1" size="14" readonly="readonly" onclick="WdatePicker()" />(单击文本框,选择年月)  
            </td>
        </tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td class="tdbgleft">
