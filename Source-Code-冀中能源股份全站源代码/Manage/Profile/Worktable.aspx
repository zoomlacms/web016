<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa_WebSite_Manages_Worktable, App_Web_0wfmhmxf" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<form id="form1" runat="server">
  ...
  <table id="ShortCutTable" class="border" cellspacing="1" width="100%" cellpadding="2" align="center" border="0">
    <tbody>
      <tr class="title">
        <td align="left" style="height: 25px;padding-left:5px;">&nbsp;<%=lang.Get("m_Worktables_welcometo")%><%=SiteName() %><%=lang.Get("m_Worktables_system")%>，<asp:Label ID="Version" runat="server"></asp:Label>。</td>
      </tr>
      <tr>
        <td style="height: 22px"><table width="550" border="0" cellpadding="0" cellspacing="0">
            <tr>
            <td align="center"><a href="../Config/SiteInfo.aspx"><img src="../../App_Themes/AdminDefaultTheme/Images/System1.png" alt="网站配置" /></a></td>
            <td align="center"><a href="../Content/ModelManage.aspx?ModelType=1"><img src="../../App_Themes/AdminDefaultTheme/images/System2.png" alt="内容模型管理" /></a></td>
            ...
            <td align="center"><a href="../User/AdminManage.aspx"><img src="../../App_Themes/AdminDefaultTheme/Images/system13.png" alt="客户端" /></a></td>
          </tr>
            <tr>
            ...
            <td align="center"><a href="../User/AdminManage.aspx" target="_blank">客户端</a></td>
          </tr>
          </table></td>
      </tr>
    </tbody>
    ...
    <script language="JavaScript">
      ...
      <td align="right"><table style="width: 100%" class="border">
          ...
          <td class="tdbgleft" colspan="2" align="left"><asp:UpdatePanel ID="UpdatePanel1" runat="server">
              <ContentTemplate>
              <asp:TextBox ID="TbRemmber" runat="server" TextMode="MultiLine" Rows="11" style="height:135px" Columns="50" AutoPostBack="true" OnTextChanged="AutoSave" class="x_input"></asp:TextBox>
            </ContentTemplate>
            </asp:UpdatePanel>
              <br />
