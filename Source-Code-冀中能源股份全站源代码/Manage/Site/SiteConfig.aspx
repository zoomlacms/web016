<%@ page language="C#" autoeventwireup="true" inherits="manage_Site_AdminLogin, App_Web_34zgrztm" masterpagefile="~/manage/Site/SiteMaster.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<asp:Content runat="server" ContentPlaceHolderID="head">
<title> 全局配置-<%Call.Label("{$SiteName/}");%></title>
...
<link href="../../App_Themes/AdminDefaultTheme/V3.css" rel="stylesheet" type="text/css" />
...
<div id="site_main">
    ...
    <div id="editDiv">
        <ul><li><input type="button" value="编辑" onclick="dis('tab4');" class="site_button"/></li></ul>
    </div>
    <div id="tab4" style="width:98%;display:none;">
        <div style="width:50%;">
        <ul class="nav nav-tabs">
            <li class="active"><a href="#tab0" data-toggle="tab">基本设置</a></li>
        </ul>
        <div class="tab-content">
            ...
            <tr><td style="padding-left:20px;">超级管理员密码：</td><td>
                ...
                <asp:Button runat="server" ID="chkBtn" Text="检测" OnClick="chkBtn_Click" style="margin-left:2px;"/>
                <asp:Button runat="server" ID="logBtn" Text="登录" OnClick="logBtn_Click" style="margin-left:2px;"/>
            </td></tr>
            ...
            <tr><td style="padding-left:20px;">新网API密码：</td><td><asp:TextBox runat="server" ID="newNetApiPasswd" TextMode="Password"
             ...
             <tr><td style="padding-left:20px;">DNS：</td>
                ...
                <tr><td style="padding-left:20px;">DNS主服务器：</td><td> <asp:TextBox runat="server" ID="dns1" MaxLength="30" /></td></tr>
                <tr><td style="padding-left:20px;">DNS辅服务器：</td><td><asp:TextBox runat="server" ID="dns2" MaxLength="30"  /></td></tr>
                </tbody>
...
2、您是否熟悉IIS的管理机制，我们的站群系统直接与IIS原生系统对接，可以托管windows的IIS管理机制，并创新的赋予了多项功能。<br/>
3、我们能够纳入非Zoomla!逐浪CMS构建的站点，且未来版本中将支持接入任意站点的数据交互，但不对非Zoomla!逐浪CMS站点构建数据安全性给予保障，我们提供免费迁移支持，可以随时访获取免费强大的Zoomla!逐浪CMS对旧版站点升级，<a href="http://www.zoomla.cn/pub" target="_blank">点此获取逐浪CMS程序包</a>。<br/>
4、开放版本与商业版本均支持自由开发与应用，商业版增进功能可以支持IDC级管理应用、并享有商业服务专用渠道，购买通道<a href="http://www.zoomla.cn/corp/about/151.shtml" target="_blank">点此访问</a>。<br/>
5、如有问题请访问<a href="http://bbs.zoomla.cn" target="_blank">bbs.zoomla.cn</a>开发专区交流，官方微博<a href="http://t.qq.com/wwwwzf" target="_blank">http://t.qq.com/wwwwzf</a>。<br/>
6、为更好的使用本系统，推荐使用最低1024*768分辨以及最低IE9版本浏览器（兼容chrome、safri等主流浏览器），不兼容IE6及低版本浏览器。</div>
</div>
</asp:Content>