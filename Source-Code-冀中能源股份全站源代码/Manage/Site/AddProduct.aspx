<%@ page language="C#" autoeventwireup="true" validaterequest="false" enableeventvalidation="false" inherits="Zoomla.Website.manage.Shop.AddProduct, App_Web_l4ylrmou" enableviewstatemac="false" masterpagefile="~/Manage/Site/OptionMaster.master" viewStateEncryptionMode="Never" %>
...
<div class="tab-pane fade" id="tab2">
    <table width="100%" border="0" cellpadding="5" cellspacing="1" class="site_border">
        <tbody id="Tabs1">
                   <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" style="height:19px;">
