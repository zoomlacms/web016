<%@ page language="C#" autoeventwireup="true" inherits="Manage_Site_DomName, App_Web_l4ylrmou" masterpagefile="~/Manage/Site/SiteMaster.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<script type="text/javascript" src="/Plugins/Domain/Site.js"></script>
    <style type="text/css">
        /*上右下左*/
        #leftDiv {
             font-family: "Helvetica Neue", Helvetica, Arial, sans-serif;width:15%;float:left;
             border:solid;border-width:1px;border-color:grey;margin-top:5px;
        ...
        .topOption {
            background-color:#08C;color:#FFF;height:30px;width:100%;font-size:14px;cursor:pointer;
            border:solid;border-width:1px;border-color:grey;
            border-style:none none solid none;}
        .topWord {display:block;height:30px;line-height:30px;padding-left:8px;}
        .oneOption { 
            background-color:#DFDFDF;color:#7E7E7E;height:30px;width:100%;font-size:14px;cursor:pointer;
            border:solid;border-width:1px;border-color:grey; border-style:none none solid none;}
        .oneWord {display:block;height:30px;line-height:30px;padding-left:24px; }
        .twoOption {
             height:30px;width:100%;font-size:14px;cursor:pointer;
             border:solid;border-width:1px;border-color:grey; border-style:none none solid none;}
