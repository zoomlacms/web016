<%@ page language="C#" autoeventwireup="true" inherits="Manage_Site_ServerClusterConfig, App_Web_l4ylrmou" masterpagefile="~/Manage/Site/SiteMaster.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="pageContent">
    ...
    <table>
            ...
            <tr>
                <td>后台管理路径：</td>
                <td>
                    <asp:TextBox runat="server" ID="customPath" CssClass="site_input" />
