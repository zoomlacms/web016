<%@ page language="C#" autoeventwireup="true" inherits="manage_Site_SiteColudSetup, App_Web_l4ylrmou" masterpagefile="~/manage/Site/SiteMaster.master" title="快云安装" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <li>
        <strong>存放地址：</strong><asp:TextBox runat="server" ID="zipSavePath" CssClass="site_input" Style="width: 315px;" />
          <asp:RegularExpressionValidator runat="server" ID="spValid" ControlToValidate="zipSavePath" ValidationExpression="^/[\w\W]*/$"
            ErrorMessage="格式不正确,必须以/开头以/结束例:/Zoomla/" Display="Dynamic" />
    </li>
    <li>
