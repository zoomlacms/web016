<%@ page language="C#" autoeventwireup="true" inherits="Manage_Site_DnsManager, App_Web_l4ylrmou" masterpagefile="~/Manage/Site/OptionMaster.master" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="pageContent">
    <div id="m_site"><p style="float: left;">站群中心 >> <a href="DnsManager.aspx">DNS管理</a></p></div>
				...
				EmptyDataText="当前没有DNS信息!!" OnPageIndexChanging="EGV_PageIndexChanging" OnRowCommand="EGV_RowCommand" >
                   <Columns>
                       ...
                       <asp:TemplateField HeaderText="操作">
                           <ItemTemplate>
                               <a href="AddDns.aspx?ID=<%#Eval("ID") %>" title="查看详情"><img src="/Plugins/ckfinder/skins/v1/images/toolbar/view.gif" /></a>
