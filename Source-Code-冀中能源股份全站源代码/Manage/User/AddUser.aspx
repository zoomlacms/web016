<%@ page language="C#" autoeventwireup="true" inherits="User.AddUser, App_Web_c5dsucp3" title="添加会员" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1">
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td align="left" class="style4" colspan="3"><asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>              
              <asp:TextBox ID="txtpassword" runat="server" CssClass="l_input" type="password" style="padding-right:6px;"></asp:TextBox>
                <span style="color: red">*</span>
