<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.User.UserPassModify, App_Web_c5dsucp3" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>修改用户信息</title>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="1" class="border">
    ...
    <tbody id="Tabs0">
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td style=" height: 25px;" colspan="3" align="left"><asp:TextBox ID="txtHoneyName" runat="server" class="l_input"></asp:TextBox></td>
      </tr>
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1">
      ...
      <tbody id="Tabs2" style="display:none" border="0" cellpadding="5" cellspacing="1">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
          ...
          <td style="width: 35%; height: 22px" align="left"><asp:TextBox ID="txtCerificateDeadLine" runat="server" class="l_input" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' })"></asp:TextBox></td>
          <td class="tdbgleft" style="width: 15%; height: 22px" align="right"> 有效期截止时间： </td>
          <td style="width: 35%; height: 22px" align="left"><asp:TextBox ID="txtDeadLine" runat="server" class="l_input" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' })"></asp:TextBox></td>
        </tr>
        <tr>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
          ...
          <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
              <td colspan="4" style="padding-left:0;"><table width="100%" border="0" cellpadding="0" >
              <asp:Literal ID="lblHtml" runat="server"></asp:Literal></table></td>
        </tr>
      </tbody>
      <tbody id="Tabs1" style="display:none">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
          ...
          <td style="width: 35%; height: 22px" align="left"><asp:TextBox ID="tbBirthday" runat="server" onblur="setday(this);" onclick="WdatePicker()"
          ...
          <td style="width: 35%; height: 22px" align="left"><asp:TextBox ID="tbOfficePhone" runat="server" class="l_input"></asp:TextBox></td>
            ...
            <tr class="tdbg">
                    ...
                    <td style="height: 22px" align="left"> <asp:TextBox ID="tbProvince" runat="server" class="l_input" style=" width:80px; "></asp:TextBox> - <asp:TextBox ID="tbCity" runat="server" class="l_input" style=" width:80px;"></asp:TextBox> - <asp:TextBox ID="tbCoutry" runat="server" class="l_input" style=" width:80px;"></asp:TextBox>   地区字典： <select runat="server" id="selprovince" onchange="javascript:area()" >
                                            </select>
          ...
          <td style="width: 35%; height: 22px" align="left"><asp:TextBox ID="tbParentUserID" runat="server" class="l_input"></asp:TextBox></td>
