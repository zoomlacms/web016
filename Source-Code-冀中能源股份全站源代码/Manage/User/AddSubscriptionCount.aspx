<%@ page language="C#" autoeventwireup="true" inherits="manage_User_AddSubscriptionCount, App_Web_nmpp3scu" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
        ...
        <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    ...
                    <asp:TextBox ID="title" runat="server" class="l_input" ReadOnly="true" TextMode="MultiLine" Height="121px" Width="264px"></asp:TextBox>
