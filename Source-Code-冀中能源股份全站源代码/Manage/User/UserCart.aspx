<%@ page language="C#" autoeventwireup="true" inherits="manage_User_UserCart, App_Web_c5dsucp3" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>用户信誉值管理</title>
...
<div class="r_navigation">后台管理 &gt;&gt; 用户管理 &gt;&gt; 会员管理 &gt;&gt; <a href='UserManage.aspx'>会员列表</a> &gt;&gt; 会员信誉值操作</div>
  <table width="100%" border="0" cellpadding="5" cellspacing="1" class="border">
    ...
    <tr class="tdbg">
      ...
      <td align="center" class="title">操作信誉值</td>
    ...
    <asp:Repeater ID="repea" runat="server">
      <ItemTemplate>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
          ...
          <td align="center"><%#DataBinder.Eval(Container.DataItem, "UserCarit", "{0}")%></td>
