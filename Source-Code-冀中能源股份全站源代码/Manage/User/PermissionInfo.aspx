<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_PermissionInfo, App_Web_nmpp3scu" enableviewstate="false" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">后台管理&gt;&gt; 角色管理&gt;&gt;<a href="PermissionInfo.aspx">角色管理</a>&nbsp;&nbsp;<a href="Permissionadd.aspx">[添加角色]</a></div>
  <table class="border" cellspacing="1" cellpadding="0" width="100%" border="0" align="center">
    ...
    <asp:Repeater ID="Pagetable" runat="server">
      <ItemTemplate>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" style=" cursor:pointer;" title="双击修改" ondblclick="Modify(<%#Eval("ID") %>)">
