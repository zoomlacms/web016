<%@ page language="C#" title="管理员角色分配" autoeventwireup="true" inherits="User.RoleManager, App_Web_nmpp3scu" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
  ...
  <div>
    <table width="99%" cellspacing="1" cellpadding="0" class="border" align="center">
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td><asp:CheckBox ID="CheckBox1" runat="server" Text="选择所有" AutoPostBack="True" OnCheckedChanged="CheckBox1_CheckedChanged"  style="margin-left:5px;"/>
          <br />
          <br />
          <asp:CheckBox id="CheckBox2" runat="server" Text="内容管理" AutoPostBack="True" OnCheckedChanged="CheckBox2_CheckedChanged"  style="margin-left:5px;"></asp:CheckBox>
          <br />
          ...
          <br />
          <asp:CheckBox id="CheckBox3" runat="server" Text="模型节点管理" AutoPostBack="True" OnCheckedChanged="CheckBox3_CheckedChanged"  style="margin-left:5px;"></asp:CheckBox>
          <br />
          ...
          <br />
          <asp:CheckBox id="CheckBox5" runat="server" Text="用户管理" AutoPostBack="True" OnCheckedChanged="CheckBox5_CheckedChanged"  style="margin-left:5px;"></asp:CheckBox>
          <br />
          ...
          <br />
          <asp:CheckBox id="CheckBox6" runat="server" Text="商城管理" AutoPostBack="True" OnCheckedChanged="CheckBox6_CheckedChanged"  style="margin-left:5px;"></asp:CheckBox>
          <br />
          ...
          <br />
          <asp:CheckBox id="CheckBox7" runat="server" Text="黄页管理" AutoPostBack="True" OnCheckedChanged="CheckBox7_CheckedChanged"  style="margin-left:5px;"></asp:CheckBox>
          <br />
          ...
          <br />
          <asp:CheckBox id="CheckBox8" runat="server" Text="店铺管理" AutoPostBack="True" OnCheckedChanged="CheckBox8_CheckedChanged"  style="margin-left:5px;"></asp:CheckBox>
          <br />
          ...
          <br />
          <asp:CheckBox id="CheckBox9" runat="server" Text="空间管理" AutoPostBack="True" OnCheckedChanged="CheckBox9_CheckedChanged"  style="margin-left:5px;"></asp:CheckBox>
          <br />
          ...
          <br />
          <asp:CheckBox id="CheckBox10" runat="server" Text="其他管理" AutoPostBack="True" OnCheckedChanged="CheckBox10_CheckedChanged" style="margin-left:5px;"></asp:CheckBox>
          <br />
