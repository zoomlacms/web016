<%@ page language="C#" autoeventwireup="true" inherits="manage_User_UserPointManage, App_Web_c5dsucp3" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>点劵管理</title>
...
<div class="r_navigation">后台管理&gt;&gt;会员管理&gt;&gt;<a href='UserManage.aspx'>会员列表</a>&gt;&gt;会员点劵操作</div>
  ...
  <table  width="100%" border="0" cellpadding="5" cellspacing="1" class="border">
    <tr class="tdbg">
      ...
      <td align="center" class="title">操作点卷</td>
      <td align="center" class="title">操作人</td>
<%--      <td align="center" class="title">操作提示</td>--%>
    ...
    <asp:Repeater ID="repea" runat="server">
      <ItemTemplate>
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
          ...
          <td align="center"><%#DataBinder.Eval(Container.DataItem, "BidPrice", "{0:.00}")%></td>
          <td align="center"><a href='AdminDetail.aspx?roleid=0&id=<%#Eval("Operator") %>' target="_blank"><%#GetUserName(Eval("Operator", "{0}"))%></a></td>
          <%--<td align="center"><%#Eval("Remark").ToString().Substring(0,Eval("Remark").ToString().IndexOf(" "))%></td>--%>
