<%@ page language="C#" autoeventwireup="true" inherits="Manage_Content_SohuChatManage, App_Web_dqwikmes" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<form id="form1" runat="server">
    ...
    <div id="configDiv" style="display:none;">
        ...
        <div class="panel panel-primary pull-left" style="width:45%; margin-left:20px;">
            <div class="panel-heading"><h3 class="panel-title">前台输出</h3></div>
            <div class="panel-body">
