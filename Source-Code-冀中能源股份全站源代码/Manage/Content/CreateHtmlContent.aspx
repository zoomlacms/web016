<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="ZoomLa.WebSite.Manage.Content.CreateHtmlContent, App_Web_dqwikmes" enableviewstatemac="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
-->    <div class="clearbox"></div>
    <div class="Creat_tips">
      <div class="alert alert-danger fade in">
        ...
        <h4>提示!</h4>
          <%#CustomerPageAction.customPath2%>
        <p>发布栏目页，需在<a href="<%=CustomerPageAction.customPath2%>Config/SiteInfo.aspx">[系统设置]</a>-节点管理对相应节点生成选项的列表首页扩展名进行设置，.aspx为不生成静态页<br />
