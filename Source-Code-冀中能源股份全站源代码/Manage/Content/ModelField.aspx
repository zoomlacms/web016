<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.ModelField, App_Web_dqwikmes" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div id="nav_box">
        <div class="r_navigation">
            ...
            <asp:Label ID="Label1" runat="server" Text=""></asp:Label>&nbsp;&nbsp;<span class="red"><a href="AddModelField.aspx?ModelID=<%=Request.QueryString["ModelID"] %>&ModelType=<%=Request["ModelType"] %>">[添加字段]</a></span>
            </div>
        </div>
