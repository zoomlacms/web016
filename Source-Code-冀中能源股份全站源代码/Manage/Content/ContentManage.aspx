<%@ page language="C#" debug="true" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.ContentManage, App_Web_yrpmb2p4" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div style="height:27px;"></div>
 ...
 <select runat="server" id="selprovince" name="selprovince" onchange="javascript:area()"></select>
   ...
   <%--     <asp:UpdatePanel ID="Article" UpdateMode="Always" runat="server"> 
            <ContentTemplate>--%>
    <ZL:ExGridView ID="Egv"  runat="server" AutoGenerateColumns="False" DataKeyNames="GeneralID" PageSize="10" OnRowDataBound="Egv_RowDataBound" OnPageIndexChanging="Egv_PageIndexChanging" IsHoldState="false" OnRowCommand="Lnk_Click" Width="100%" Height="20px" AllowPaging="True" AllowSorting="True" CellPadding="2" CellSpacing="1" BackColor="White" ForeColor="Black" CssClass="border" EnableTheming="False" RowStyle-CssClass="tdbg" GridLines="None" EnableModelValidation="True">
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    ...
                    <asp:LinkButton ID="lbBid" runat="server" CommandName="bider" CommandArgument='<%#Eval("GeneralID") %>'
                        Visible='<%#getBid(Eval("GeneralID")) %>'> |<%#lang.Get("m_ContentManage_examine")%></asp:LinkButton>
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" BorderColor="White" />
            </asp:TemplateField>
        </Columns>
