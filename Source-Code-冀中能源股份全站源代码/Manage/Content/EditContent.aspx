<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="ZoomLa.WebSite.Manage.Content.EditContent, App_Web_dqwikmes" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<style>
#change{text-align:center;	WIDTH: 100%; display:block;overflow:hidden;margin:0 auto;RIGHT: 0px; BOTTOM: 0px;POSITION:fixed;_POSITION: absolute;_TOP: expression(offsetParent.scrollTop+document.documentElement.clientHeight-this.offsetHeight);z-index:9999;}
