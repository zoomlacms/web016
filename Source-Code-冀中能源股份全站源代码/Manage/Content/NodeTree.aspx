<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.NodeTree, App_Web_dqwikmes" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<li> 
    ...
    <table  cellpadding="2" cellspacing="1" class="l_input" style="background:#fff;"><tr><td>
        <asp:TextBox ID="Lname" runat="server"  class="l_inpnon" style="color:#666; width:150px; height:20px; "
            Text="请输入文章标题或ID" onfocus="if (this.value == '请输入文章标题或ID') { this.value = ''; this.style.color = 'black';}"
               onblur="if(this.value==''){this.value='请输入文章标题或ID';this.style.color='#666;width:150px; height:20px;  ';}" 
...
<li id="Guide_main">
    ...
    <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="true"></ZL:ExGridView>
</form>
</body>
</html>
