<%@ page language="C#" autoeventwireup="true" inherits="manage_Template_DSManage, App_Web_oj1vogc4" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <div id="addDSDiv" runat="server" visible="false">
                <table style="width: 50%; border: 0;" class="tdbg" cellpadding="0" cellspacing="1" >
                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        ...
                        <td class="tdbgleft" style="width: 15%; height: 22px; text-align: left;">
                            <asp:TextBox ID="DSName" runat="server"  MaxLength="20" width="30%"/> <span style="color:red">*</span>
                    ...
                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                     ...
                     <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        ...
                        <td class="tdbgleft" style="height: 22px; text-align: left;">
                            <asp:TextBox ID="dsRemind" runat="server" Width="70%" MaxLength="50"/>
                        </td>
                    </tr>
                     <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        <td class="tdbgleft" style="text-align:right;"> 数据库源连接字符串： </td>
                        <td class="tdbgleft" style="height: 22px; text-align: left;">
                            <asp:TextBox ID="DBConnectText" runat="server" Width="70%" Text="Data Source=(local);Initial Catalog=test;User ID=test;Password=test"  MaxLength="100"/>
                            <span style="color:red">*</span>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="DBConnectText"
                                ErrorMessage="连接字符串不能为空!" SetFocusOnError="True" Display="Dynamic" />
