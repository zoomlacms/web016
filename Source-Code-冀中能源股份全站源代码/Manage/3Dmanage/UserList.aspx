<%@ page language="C#" autoeventwireup="true" inherits="manage_3Dmanage_UserList, App_Web_22dot3o5" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
			...
			<tr class="title">
				...
				<td align="right">
					<asp:TextBox ID="TxtKeyWord" class="l_input" runat="server"></asp:TextBox>&nbsp;&nbsp;<asp:Button
						ID="BtnSearch" runat="server" Text=""   CssClass="C_sch"/></td>
			</tr>
			<tr>
