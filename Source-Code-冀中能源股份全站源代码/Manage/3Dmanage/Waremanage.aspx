<%@ page language="C#" autoeventwireup="true" inherits="manage_3Dmanage_Waremanage, App_Web_22dot3o5" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">
	...
	<tbody id="Tbody2">
	  ...
	  <asp:TextBox ID="souchkey" BorderColor="#fff" CssClass="l_inpnon" runat="server"  />
	  <asp:Button ID="souchok" runat="server" Text="" OnClick="souchok_Click" class="C_sch" />
                    </td></tr></table>
			</td>
		</tr>
		</tbody>
