<%@ page language="C#" autoeventwireup="true" inherits="manage_3Dmanage_ADDUser, App_Web_22dot3o5" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
		...
		<table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
			<tbody id="Tbody1">
				...
				<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
					...
					<td align="left"  style="height: 24px;">
						<asp:TextBox ID="Dexpiry" class="l_input" runat="server" Width="205px" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd' });"></asp:TextBox>
