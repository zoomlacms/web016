<%@ page language="C#" autoeventwireup="true" inherits="manage_Common_CutPic, App_Web_dg01cap2" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
<input id="BtnReCut" type="button"  value="使用原图" onclick="window.close();" /> 
</div>
