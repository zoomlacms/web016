<%@ page language="C#" autoeventwireup="true" inherits="Manage_Shop_OtherOrder_BountProduct, App_Web_axzg0iyp" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="h_27"></div>
    <div class="sitelist">
        <ZL:ExGridView ID="EGV"  runat="server" AutoGenerateColumns="False" PageSize="20" OnRowCommand="EGV_RowCommand" OnPageIndexChanging="EGV_PageIndexChanging" IsHoldState="false" Width="100%" Height="20px" AllowPaging="True" AllowSorting="True" CellPadding="2" CellSpacing="1" BackColor="White" ForeColor="Black" CssClass="border" EnableTheming="False" RowStyle-CssClass="tdbg" GridLines="None" EnableModelValidation="True">
