<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Page.UserModelField, App_Web_xkxqwymn" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="r_navigation" runat="server">
	...
	<span>后台管理</span> &gt;&gt; 企业黄页 &gt;&gt; <a href="UserModelManage.aspx">黄页申请设置</a> &gt;&gt; <span>样式字段列表</span>&nbsp;&nbsp;&nbsp;&nbsp;<span>当前申请样式:[<asp:Literal ID="LModelName" runat="server"></asp:Literal>] &nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>&nbsp;<span class="red"><a href="AdduserField.aspx?ModelID=<%=Request.QueryString["ModelID"] %>">[添加字段]</a></span></span>       
</div>
</div>
