<%@ page language="C#" autoeventwireup="true" inherits="manage_Page_StyleManage, App_Web_xkxqwymn" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <asp:Repeater ID="Styleable" runat="server">
                <ItemTemplate>
                    <tr class="tdbg" id="<%#Eval("id")%>" ondblclick="getinfo(this.id)" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        ...
                        <td style="height:24px" align="center">
                            <img alt="" src="/UploadFiles/<%#Eval("ShowImg")%>" width="60" height="60" onerror="this.src='/UploadFiles/nopic.gif';"/>
                        </td>
                        <td style="height:24px" align="center">
                            <%#Eval("StyleUrl", "{0}")%>
                        </td>
