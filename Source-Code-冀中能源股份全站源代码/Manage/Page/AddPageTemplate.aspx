<%@ page language="C#" autoeventwireup="true" inherits="manage.Page.AddPageTemplate, App_Web_xkxqwymn" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="r_navigation">
      ...
      <asp:Panel ID="typenode" runat="server">
        ...
        <tr class="tdbg" id="Tr2">
          ...
          <td align="left"><asp:TextBox ID="addtime" class="l_input"  runat="server" Width="165px" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });"></asp:TextBox></td>
