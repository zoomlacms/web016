<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Page.PageContent, App_Web_0he0ok20" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table  cellpadding="2" border="0" cellspacing="1" style="background:#fff;" class="l_input"><tr ><td> 
                ...
                <asp:Button ID="Button4" runat="server" Text="" OnClick="Button4_Click" class="C_sch" />&nbsp;</td></tr></table>
                 
            </li>
           <li>   <%=lang.Get("m_ContentManage_Ucity")%>：  <select runat="server" id="selprovince" name="selprovince" onchange="javascript:area()">
                                            </select>
