<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Plus.Survey, App_Web_o53mvtm5" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>编辑问卷投票</title>
...
<form id="form1" runat="server">
  ...
  <table class="border" width="100%" cellpadding="2" cellspacing="1">
    ...
    <tr class="tdbg">
      ...
      <td><asp:CheckBox ID="ChkNeedLogin" runat="server" Checked="true"/>
        是</td>
    </tr>
    <tr class="tdbg">
    ...
    <tr class="tdbg">
      ...
      <td><asp:CheckBox ID="ChkIsStatus" runat="server" Checked="true"/>是</td>
    </tr>
    <tr class="tdbg">
      <td class="tdbgleft"><strong>是否启用验证码：</strong></td>
      <td><asp:CheckBox ID="ChkIsCheck" runat="server" Checked="true"/>是</td>
    </tr>
    <tr class="tdbgbottom">
