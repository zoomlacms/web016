<%@ page language="C#" autoeventwireup="true" inherits="manage_UserShopManage_ProductManage, App_Web_bo0wi31c" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
		...
		<asp:Repeater ID="Productlist" runat="server">
			<ItemTemplate>
				<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
					...
					<td height="24" align="center">
						<a href="/Store/Shopinfo.aspx?ItemID=<%# Eval("id") %>" target="_blank"><%#getproimg(DataBinder.Eval(Container,"DataItem.Thumbnails","{0}"))%></a>
					</td>
					<td height="24" align="center">
						<a href="/Store/Shopinfo.aspx?ItemID=<%# Eval("id") %>" target="_blank"><%#DataBinder.Eval(Container.DataItem,"ProName")%></a>
					</td>
					<td height="24" align="center">
					...
					<td height="24" align="center" ondblclick="DBClickOpenPage()">
