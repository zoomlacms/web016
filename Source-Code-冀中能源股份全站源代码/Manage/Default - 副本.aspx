                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="height: 24px; font-size: 12px">
                                                    ...
                                                    <input id="cu5" name="cUser" type="checkbox" style="display:none;" checked="checked" />订阅中心
                                                    <input id="cu6" name="cUser" type="checkbox" style="display:none;" checked="checked" />人才招聘
                                                    <input id="cu7" name="cUser" type="checkbox" style="display:none;" checked="checked" />社区(SNS)模块
                                                    <input id="cu8" name="cUser" type="checkbox"  style="display:none;"checked="checked" />微博管理
                                                    <input id="cu9" name="cUser" type="checkbox" style="display:none;" checked="checked" />3D地带<br />&nbsp;
                                                    <input id="cu10" name="cUser" type="checkbox" style="display:none;" checked="checked" />Nite视频面试管理
                                                    <input id="cu11" name="cUser" type="checkbox"  style="display:none;"checked="checked" />多人视频管理
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tbody>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="height: 24px; font-size: 12px">
                                                    ...
                                                    <input id="ou5" name="oUser" type="checkbox" style="display:none;" checked="checked" />订阅中心
                                                    <input id="ou6" name="oUser" type="checkbox" style="display:none;" checked="checked" />人才招聘
                                                    <input id="ou7" name="oUser" type="checkbox" style="display:none;" checked="checked" />社区(SNS)模块
                                                    <input id="ou8" name="oUser" type="checkbox" style="display:none;" checked="checked" />微博管理
                                                    <input id="ou9" name="oUser" type="checkbox" style="display:none;" checked="checked" />3D地带<br />
                                                    &nbsp;&nbsp;<input id="ou10" name="oUser" style="display:none;" type="checkbox" checked="checked" />Nite视频面试管理
                                                    <input id="ou11" name="oUser" type="checkbox" style="display:none;" checked="checked" />多人视频管理
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tbody>
