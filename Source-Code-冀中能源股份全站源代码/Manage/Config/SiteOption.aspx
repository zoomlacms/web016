<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.SiteConfig.SiteOption, App_Web_ty1ftkok" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
.style2 { height: 25px; padding-left:8px;}
.tdrbtn{ padding-left:8px;}
</style>
</head>
<body>
  ...
  <table width="99%" cellspacing="1" cellpadding="0" class="border">
    <tbody id="Tabs0">
      ...
      <tr class="tdbg" runat="server" id="Tr5">
        ...
        <td class="tdbgleft" style="width: 200px"><strong>设备自适配：</strong></td>
        <td><div style="float:left"><asp:RadioButtonList ID="UAgent" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="UAgent_TextChanged" >
            <asp:ListItem Value="1">开启</asp:ListItem>
            <asp:ListItem Value="0" Selected="True">关闭</asp:ListItem>
          </asp:RadioButtonList>
            </div><div style="float:left; padding-top:3px;"><span ID="uaMag" runat="server"> [<a href="../AddOn/UAgent.aspx" style="color: blue;">设置</a>]</span></div>
        </td>
      </tr>
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
      <td class="tdbgleft" style="width: 200px; height: 23px;">
       ...
       <td>
           ...
           <div style="float:left; padding-top:3px;"> <asp:CheckBox ID="DeleteLocal" style="color:Red;" runat="server" />
       <span id="PromptHelp" runat="server">(<a id="PromptHelps" runat="server" href="http://update.zoomla.cn/help.rar" style=" color:Blue;"  target="_blank" >下载离线帮助包</a>)</span></div>
       </td>
    </tr>
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
      ...
      <td style="padding-left:8px;"><asp:RadioButton ID="rdoIapTrue" runat="server" GroupName="IsAbsoluatePath" TabIndex="1" Text="相对路径" />
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
      ...
      <td style="padding-left:8px;"><input type="radio" runat="server" name="SMSTips" id="SMSTipsTrue" value="true" />开启 <input type="radio" runat="server" name="SMSTips" id="SMSTipsFalse" value="false" />关闭 </td>
    </tr>
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
    ...
    <tbody id="Tabs1" style="display: none">
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td style="padding-left:8px;"><asp:RadioButton ID="rdoIzTrue" runat="server" GroupName="IsZone" TabIndex="1" Text="是" />
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td style="padding-left:8px;"><asp:RadioButton ID="rdoImTrue" runat="server" GroupName="IsMall" TabIndex="1" Text="是" />
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
      ...
      <td style="padding-left:8px;"><input type="radio" runat="server"  name="cloudLeadTips" id="cloudLeadTipsTrue" value="true" />开启
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td>
            <asp:TextBox ID="TxtIndexTemplate" runat="server" CssClass="l_input"></asp:TextBox>
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td><asp:TextBox ID="txtShopTemplate" runat="server" CssClass="l_input"></asp:TextBox>
          <input type="button" value="选择模板" onclick="WinOpenDialog('../Template/TemplateList.aspx?OpenerText='+escape('txtShopTemplate')+'&FilesDir=',650,480)" class="C_input" />
        </td>
      </tr>
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td>
            <div id="DivtemplateDir">
                ...
                <asp:Button ID="Button2" OnClick="Button2_Click" OnClientClick="document.getElementById('lblKai').innerText='开销中...';" runat="server" Text="一键开销" CssClass="C_input" />
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td>
            <div id="DivCssDir">
                ...
                <span style="color: Red">*提示：为保证风格能够与云台结合使用，请继承上一项的模板目录</span>
            </div>
        </td>
      </tr>
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
    ...
    <tbody id="Tabs2" style="display: none">
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td><asp:TextBox ID="txtSiteManageCode" runat="server" CssClass="l_input"></asp:TextBox></td>
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td class="tdbgleft"><strong>开启SQL防注入(Post与Cookies检测)：</strong></td>
        <td style="padding-left:6px;">
            <asp:RadioButton ID="sqlInject1" runat="server" GroupName="SqlInjectOption" TabIndex="1" Text="是" />
            <asp:RadioButton ID="sqlInject2" runat="server" GroupName="SqlInjectOption" TabIndex="2" Text="否"/>
        </td>
      </tr>
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td><asp:RadioButtonList ID="rdoBtnLSh" runat="server" RepeatDirection="Horizontal" CellPadding="0" CellSpacing="0">
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td><asp:RadioButtonList ID="MailPermission" runat="server" RepeatDirection="Horizontal" CellPadding="0" CellSpacing="0">
      ...
      <tr class="tdbg" runat="server" id="Tr2" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td>
            <asp:TextBox ID="FlexKey" Width="360px" runat="server" CssClass="l_input"></asp:TextBox>
        </td>
      </tr>
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td>
           ...
           <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" >
               <td class="tdbgleft" style="width: 300px"><strong>是否过滤敏感词汇：</strong></td>
               <td>
    ...
    <tbody id="Tabs3" style="display: none">
     ...
     <%--  <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td><asp:TextBox ID="txtUploadFileExts" runat="server" CssClass="x_input" TextMode="MultiLine"  Rows="3" Columns="60" /></td>
      </tr>
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td><asp:TextBox ID="TxtUpPicExt" runat="server" CssClass="x_input" TextMode="MultiLine"  Rows="3" Columns="60" /></td>
      </tr>
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td><asp:TextBox ID="TxtUpMediaExt" runat="server" CssClass="x_input" TextMode="MultiLine"  Rows="3" Columns="60" /></td>
      </tr>
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td class="tdbgleft" style="width: 200px"><strong>是否允许上传文件：</strong></td>
        <td style="padding-left:8px;"><asp:RadioButton ID="rdoEufTrue" runat="server" GroupName="EnableUploadFiles" TabIndex="1" Text="是" />
          <asp:RadioButton ID="rdoEufFalse" runat="server" GroupName="EnableUploadFiles" TabIndex="2" Text="否"/></td>
      </tr>
    </tbody>
    <tbody id="Tabs4" style="display: none">
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <asp:UpdatePanel runat="server" ID="Update1">
                <ContentTemplate>
                    ...
                    <div id="Api" runat="server" visible="false">
                        <asp:TextBox ID="TB_Api" runat="server" CssClass="l_input"></asp:TextBox>&nbsp;
       ...
       <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        <td class="tdbgleft" style="width: 200px; height: 23px;"><strong> 免邮方式：</strong></td>
        <td>  <asp:TextBox ID="TB_pronum" runat="server" CssClass="l_input" Width="20"></asp:TextBox> 件 提示：购买商品超出此数量免邮(0为不免邮)  </td></tr>
    </tbody>
  </table>
  <br />
  <asp:Button ID="Button1" runat="server" Text="保存设置" OnClick="Button1_Click" CssClass="C_input" OnClientClick="setTimeout(function () { document.getElementById('Button1').disabled = true;},50)" />
  <asp:Button ID="btnReset" runat="server" CssClass="C_input" Text="重置" OnClientClick="return confirm('重置后所有信息都需重新设置,确定要重置吗?')" OnClick="btnReset_Click" />
