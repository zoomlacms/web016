<%@ page language="C#" autoeventwireup="true" inherits="manage_Workload_Subject, App_Web_i4pbhju5" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html >
<html>
...
{ %>
    ...
    <tr valign="middle">
        <td class="spacingtitle" colspan="2" style="height: 26px; text-align: center">
            <strong> <asp:Label ID="title" runat="server" Text=""></asp:Label></strong>
        </td>
    </tr>
</table>
