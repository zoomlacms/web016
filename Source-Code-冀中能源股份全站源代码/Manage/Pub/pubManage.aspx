<%@ page language="C#" autoeventwireup="true" inherits="manage_Pub_pubManage, App_Web_ya3njpmp" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="h_27"></div>
    <table cellpadding="2" cellspacing="1" class="border" style="background-color: white;" width="100%">
        ...
        <ItemTemplate>
        <tr class="tdbg"  runat="server" id="Tr1" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" ondblclick="getinfo(this.id )" >
            <td align="center" height="24" width="5%">
                <b><a href="ViewPub.aspx?Pubid=<%#Eval("PubID")%>&guang=all"> <%#Eval("Pubid") %></a></b>
            </td>
            <td align="center" height="24" width="20%">
