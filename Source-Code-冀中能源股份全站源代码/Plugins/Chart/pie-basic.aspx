<%@ page language="C#" autoeventwireup="true" inherits="Skin_pie_basic, App_Web_00amhgsl" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html >
<head runat="server">
    <title></title>
...
<body>
    ...
    <%--<div id="container" style="width:<%=BiaoS.Width %>px; height:<%=BiaoS.Height %>px; margin:0;float:left"></div>--%>
        <div id="container" style="width:200px; height:200px; margin:0;float:left"></div>
    </form>
</body>
</html>
