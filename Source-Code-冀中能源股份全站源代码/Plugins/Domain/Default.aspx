<%@ page language="C#" autoeventwireup="true" inherits="Manage_Site_DomReg, App_Web_fxv1p0b4" masterpagefile="~/Manage/Site/SiteMaster2.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="pageContent">
        <div id="m_site"><p style="float:left;"> 站群中心 >> 域名注册
            <a href="?op=ViewCart&remote=<%=remote %>" title="查看购物车" style="margin-left:10px;">
                <img src="/Images/ModelIcon/cart.gif" style="position:relative;top:2px;" />购物车</a>
             <a href="/User/Default.aspx" title="进入会员中心" style="margin-left:5px;">
                 <img src="/App_Themes/AdminDefaultTheme/images/manage_user.jpg" style="position:relative;top:2px;width:14px;height:14px;" />会员中心</a>
            <a href="Default.aspx?remote=<%=remote %>" title="返回首页" style="margin-left:5px;">
                <img src="/Images/up.gif"  style="position:relative;top:2px;width:14px;height:14px;"/>返回首页</a>
                         </p></div>
    <div id="site_main">
  ...
  <div class="cartSteps">
      ...
      <div id="lastEditDiv">
		...
		<div class="domain_middle">
			<textarea  name="domainBody" id="Textarea1" class="medium small domain_textarea" onfocus="empty(this);" onblur="fill(this);"><%=prompt %></textarea>
			<br />
