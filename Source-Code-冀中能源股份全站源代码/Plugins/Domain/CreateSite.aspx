<%@ page language="C#" autoeventwireup="true" inherits="Manage_Site_IDE_CreateSite, App_Web_fxv1p0b4" masterpagefile="~/Manage/Site/SiteMaster2.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="pageContent">
 ...
 <div id="site_main" style="margin-top:15px;">
        ...
        <asp:Repeater runat="server" ID="tempRepeater">
            <ItemTemplate>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer" style="text-align:left;">
                <asp:Button runat="server" ID="userRegBtn" Text="继续" class="btn btn-primary" OnClick="sureBtn_Click"/>
            </div>
          </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
      </div>
