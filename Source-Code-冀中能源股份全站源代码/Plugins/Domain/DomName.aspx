<%@ page language="C#" autoeventwireup="true" inherits="Manage_Site_DomName, App_Web_fxv1p0b4" masterpagefile="~/Manage/Site/SiteMaster2.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div id="site_main">
    <div id="leftDiv">
        ...
        <div class="twoOption"><a href="javascript:;" id="tabBtn1" onclick="openFrame('Default.aspx?remote=true')"><span class="twoWord">域名注册</span></a></div>
        <div class="twoOption"><a href="javascript:;" id="tabBtn3" onclick="ShowTabs(this,'tab3')"><span class="twoWord">域名管理</span></a></div>
        <div class="twoOption"><a href="InquiryDomName.aspx" target="_blank"><span class="twoWord">智能建站</span></a></div>
        <div class="twoOption"><a href="javascript:;" id="tabBtn2" onclick="ShowTabs(this,'tab2')"><span class="twoWord">注册模板</span></a></div>
        <div class="twoOption"><a href="javascript:;" id="tabBtn4" onclick="ShowTabs(this,'tab4')"><span class="twoWord">操作日志</span></a></div>
        ...
        <div class="twoOption"><a href="javascript:;" id="A1" onclick="ShowTabs(this,'tab1');openFrame('ViewHave.aspx')"><span class="twoWord">查看已购买服务</span></a></div>
        <div class="twoOption"><a href="javascript:;" id="tabBtn5" onclick="ShowTabs(this,'tab5')"><span class="twoWord">充值</span></a></div>
    </div>
    <div id="rightDiv">
    <div id="tab1">
        <iframe id="tab1Frame" onload="frameInit(this,'tab1Frame');"  src="Default.aspx?remote=true" style="width:98%;" frameborder=0 scrolling=yes></iframe>
    </div>
...
<%--                     <asp:TemplateField HeaderText="站点名">
    ...
    <div id="tab4" style="display:none;">
        <iframe id="tab4Frame" onload="frameInit(this,'tab4Frame');"  src="ViewUserLog.aspx" style="width:98%;" frameborder=0 scrolling=no></iframe>
    </div>
        <div id="tab5" style="display:none;">
        充值金额:<asp:TextBox runat="server" ID="chargeText" CssClass="site_input"/>
           <asp:RequiredFieldValidator runat="server" ControlToValidate="chargeText" Display="Dynamic" ForeColor="Red" ErrorMessage="不能为空!" ValidationGroup="chargeG"/>
            <asp:RegularExpressionValidator runat="server" ControlToValidate="chargeText"  Display="Dynamic" ForeColor="Red" ErrorMessage="必须为整数" 
                ValidationExpression="^\d+(\d+)?$" ValidationGroup="chargeG"/>
           <br /> <asp:Button runat="server" ID="beginCharge" Text="充值" OnClick="beginCharge_Click" CssClass="site_button" ValidationGroup="chargeG"/>
    </div>
    </div>
<br />
