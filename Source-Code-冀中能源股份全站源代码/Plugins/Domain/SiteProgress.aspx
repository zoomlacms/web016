<%@ page language="C#" autoeventwireup="true" inherits="Plugins_Domain_SiteProgress, App_Web_fxv1p0b4" masterpagefile="~/Manage/Site/SiteMaster2.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="pageContent">
    ...
    <table style="width:40%;">
     ...
     <tr><td style="width:20%;"><label> 绑定域名：</label></td><td>
         ...
         <a href="Default.aspx" target="_applyDom" class="btn btn-primary" style="color:white;">申请域名</a>
         <a href="Default.aspx" target="_applyDom" class="btn btn-primary" style="color:white;">绑定域名</a>
      </td></tr>
