<%@ page language="C#" autoeventwireup="true" inherits="Common_EmailSender, App_Web_zlojhnt5" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<html><head>
<title>
邮件发送
</title>  
...
//<![CDATA[
     UE.getEditor('con',
{
    toolbars : [['FullScreen','Source','Undo', 'Redo','Bold', 'Italic', 'NumberedList', 'BulletedList',   'Smiley', 'ShowBlocks', 'Maximize', 'bold', 'italic', 'underline', 'fontborder', 'strikethrough', '|', 'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify','|', 'help']]
});
//]]>
</script>
 </td></tr>
