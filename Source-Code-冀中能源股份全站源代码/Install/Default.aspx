<%@ page language="C#" autoeventwireup="true" inherits="Install_Default, App_Web_roo0xgty" responseencoding="utf-8" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<link href="/Template/V3/style/global.css" rel="stylesheet" type="text/css" />
...
<div class="row">
<div class="col-lg-3">
<div class="inslogo"><a href="http://www.zoomla.cn/" target="_blank"><img src="/Install/images/logo.jpg" alt="欢迎使用逐浪CMS" /></a></div>
</div>
<div class="col-lg-5">
<ul>
...
<asp:Button ID="StartNextButton" runat="server" Enabled="False" CommandName="MoveNext" Text="下一步" class="netxpage" Width="60" Height="24"/>
</div>
...
<tr>
    <td><asp:Label ID="Label1" runat="server" style="padding-right:15px;"></asp:Label></td>
...
<div class="insbox_txt" style=" padding-left:0px;width:620px; margin:auto;padding-top:15px; line-height:15px;">请确保目标数据库中没有同名表和存储过程。<br />
</div>
<div id="checkedshi">
<table cellspacing="0" cellpadding="0" class="ins_date" height="290px">
    <tr>
      <td style="height:16px; width:90px;">数据库版本：</td>
        <td>
            <asp:DropDownList ID="DropSqlVersion" runat="server" Width="220px">
...
<div class="clearfix"></div>
<div class="install">
<div class="biao" ><span style="margin-left:345px;_margin-left:350px;"></span>
</div>
...
<tr><td>
<asp:Button ID="BtnCreateDateBase" class="C_input" runat="server" OnClientClick="ShowProgress();" Text="开始创建"  OnClick="BtnCreateDateBase_Click" Width="70" Height="26" /> 
</td></tr>
</table>
</ContentTemplate>
</asp:UpdatePanel>
...
<div class="clearfix"></div>
 ...
 <div class="clearfix"></div>
 <div class="install" style="_margin-top:80px;margin-top:60px;">
...
<div class="insbox">
<h1>第五步：配置网站基本信息</h1>
<div class="insbox_txt" style="width:600px; margin:auto;padding-left:0px;">您可以在安装好后，于网站后台重新配置网站基本信息及设置。</div>

<table cellspacing="0" cellpadding="0" class="table_date">
   <tr>
        <td style="width:30%; height:21px;">网站名称：</td>
        <td>
    ...
    <tr>
        <td style="width: 30%;height:21px;">网站标题：</td>
        <td>
    ...
    <tr>
     ...
     <tr>
        ...
        <td>
            <asp:TextBox ID="TxtEmail" runat="server" Width="180px" class="l_input" Text="web@Zoomla.cn"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TxtEmail" ErrorMessage="Email不能为空!" Display="Dynamic"></asp:RequiredFieldValidator><asp:RegularExpressionValidator
ID="RegularExpressionValidator1" runat="server" ErrorMessage="Email格式不正确" ControlToValidate="TxtEmail" Display="Dynamic" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator></td>
    ...
    <tr>
        <td style="height: 15px;+height:10px;" colspan="2">
        </td>
    </tr>
    ...
    <tr>
        ...
        <asp:TextBox ID="TxtAdminPassword" runat="server" Width="180px" TextMode="Password" class="l_input"></asp:TextBox> <asp:RegularExpressionValidator ID="ValgTextMaxLength" ControlToValidate="TxtAdminPassword"
                                            ValidationExpression="^[a-zA-Z0-9_\u4e00-\u9fa5\@\.]{6,40}$" SetFocusOnError="false"
                                             runat="server" Display="Dynamic" ErrorMessage="密码不能少于六位"></asp:RegularExpressionValidator><asp:RequiredFieldValidator ID="ValrAdminPassword" runat="server" ControlToValidate="TxtAdminPassword" ErrorMessage="管理员密码不能为空!"></asp:RequiredFieldValidator></td>
    ...
    <tr>
     ...
     <tr>
        <td style="height: 23px">后台路径：</td>
        <td style="height: 23px">
            <asp:TextBox ID="TxtCustomPath" runat="server" Width="180px" class="l_input" Text="Admin" MaxLength="10" onkeyup="value=value.replace(/[^\w]/ig,'');check(this);"  Title="请输入最少三位,最多十位,可英文与数字组合"/> 
    ...
    <tr>
        <td>后台管理认证码：</td>
        <td>
            <asp:TextBox ID="TxtSiteManageCode" runat="server" Width="180px" Text="8888" class="l_input"  onkeyup="check2(this)"></asp:TextBox>
...
<div class="clearfix"></div>
<div class="install">
<div class="biao" style="margin-top:0x;">
...
<div class="insbox">
<h1>第六步：恭喜完成安装！</h1>
<div class="insbox_txt" style="width:300px; margin:auto;padding-left:0px; margin-top:50px;">已经成功安装，<br />
 请点击“<strong>完成安装</strong>”按钮跳转到首页。<br />
<br /><br />
<input id="HdnPassword" type="hidden" visible="False" runat="server" />
<asp:Button ID="PreviousButtonFinish" runat="server" CausesValidation="False" CommandName="MovePrevious" Text="重新配置" Width="70" Height="26" />
<input name="Finish" type="button" id="Finish" value="完成安装" onClick="javascript:window.location.href='../Default.aspx'" style="width:70px; height:26px;"/>
</div>
