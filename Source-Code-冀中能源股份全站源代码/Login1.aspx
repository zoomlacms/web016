<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite._Login, App_Web_jaj0qu3e" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<style>
body{ background:#BB1C10}
#login li{ float:left; color:#fff; margin-right:10px;}
.l_input{ background:url(Template/Party/style/images/build/login.jpg) no-repeat; border:none; width:116px; height:20px;}
#BtnLogin{ background:url(Template/Party/style/images/build/login_bg.gif) no-repeat; border:none; color:#fff;}
#login li a{ color:#fff;}
#logged li{ float:left; color:#fff; margin-left:5px;}
#logged li a{ color:#fff;}
</style></head>
<body>
...
<asp:Panel ID="PnlLoginStatus" runat="server">
    <div id="logged">
        <ul>
          ...
          <li style="display:none"><asp:Literal ID="LitLoginDate" runat="server">0</asp:Literal></li>               
