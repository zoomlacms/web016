<%@ page language="C#" autoeventwireup="true" inherits="App_Default, App_Web_adhvg1js" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
	...
	<div data-role="content">
		<div class="content-secondary">
			...
			<nav>
				...
				<li data-role="list-divider">  <%Call.Label("{ZL.Label id=\"输出指定ID节点名\" NodeID=\"99\" /}"); %></li>
				<%Call.Label("{ZL.Label id=\"节点列表App\" ParentID=\"99\" ShowNum=\"30\" /}"); %>
