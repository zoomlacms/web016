<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Comment.CommentFor, App_Web_vqnyr2pd" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head  >
<title>发表评论</title>
          ...
          <div class="fuMian" >
            ...
            <div class="fuRight" runat="server">
              <div id="rigth1" runat="server">
                ...
                <br />
                <iframe  frameborder="0" marginheight="0" marginwidth="0" scrolling="no" width="300" height="60"  src="/Common/FileUpload.aspx?Id=<%=Request.QueryString["ID"] %>&FieldName=Files&type=For"></iframe>
              </div>
