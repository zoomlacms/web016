<%@ page language="C#" autoeventwireup="true" inherits="StoreCart, App_Web_fsr0l2af" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
<title>加入购物车</title>
...
<form id="form1" runat="server">
  <div id="main" class="rg_inout">
   ...
   店铺名称:<asp:Label runat="server" ID="L_Shop"></asp:Label>
    ...
    <ItemTemplate>
    <div class="cart_con">
        <ul><%--http://localhost:86/store/Shopinfo.aspx?itemid=4--%>
