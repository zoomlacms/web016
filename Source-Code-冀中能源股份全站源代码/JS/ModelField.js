  ...
  //  var TextType=document.getElementById("DivTextType");
    ...
    for (var i = 0; i < TypeCount.length; i++) {
        ...
        { 
            ...
            if (tid == "MobileSMSType" || tid == "PicType" || document.getElementsByName("Type")[i].value == "SqlType" || tid == "SqlFile"  || tid == "MultiPicType" || tid == "FileType" || tid == "SuperLinkType" || tid == "ColorType")
            { 
