<%@ page language="C#" autoeventwireup="true" inherits="User_UserShop_ProductAdd, App_Web_vzrss5js" validaterequest="false" enableviewstate="False" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                            ...
                            <td>
                             <asp:UpdatePanel ID="UpdatePanel2" runat="server">
								 ...
								 <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" width="100%">
									...
									<td><div id='hotelDiv'><asp:TextBox id='CheckInDate' runat="server" Text="" class="l_input" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });"></asp:TextBox>至 
									<asp:TextBox id='CheckOutDate' runat="server" Text="" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" class="l_input"></asp:TextBox></div>
