<%@ page language="C#" autoeventwireup="true" inherits="User_UserShop_ProductSaleList, App_Web_vzrss5js" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<asp:TextBox ID="toptime" runat="server" Width="109px" onclick="WdatePicker();" />
		<asp:Image ID="Image2" runat="server" 
			ImageUrl="~/App_Themes/AdminDefaultTheme/images/Calendar.gif" />&nbsp;
	至
	<asp:TextBox ID="endtime" runat="server" Width="109px" onclick="WdatePicker();" />&nbsp;<asp:Image
