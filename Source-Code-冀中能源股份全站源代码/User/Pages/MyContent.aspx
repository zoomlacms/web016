<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.Content.MyContent, App_Web_hlqfda2h" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>我的内容</title>
...
<body>
   <div class="us_seta">
        <span><asp:Label ID="lblNodeName" runat="server" Text="Label"></asp:Label></span><span> &gt;&gt; </span><span><asp:Label ID="lblAddContent" runat="server" Text="Label"></asp:Label></span>

       <a href="Recyle.aspx" style="color:blue;margin-left:10px;">进入回收站</a>
   </div>
    ...
    <div class="us_seta">
       ...
       <li style="width:100%; float:left;line-height:30px">
            ...
            OnClientClick="if(!IsSelectedId()){alert('请选择删除项');return false;}else{return confirm('你确定要将所有选择项删除到回收站吗？')}"
