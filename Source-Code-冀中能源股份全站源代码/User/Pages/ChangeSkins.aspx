<%@ page language="C#" autoeventwireup="true" inherits="User_Pages_ChangeSkins, App_Web_hlqfda2h" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
      ...
      <asp:Repeater ID="Repeater1" runat="server">
        <ItemTemplate>
          <li style="width: 33%; float: left; text-align: center;">
            <table width="50%">
              <tr>
                <td><img alt="" src="../../<%#Eval("ShowImg") %>" width="60px" height="60px" onerror="this.src='/UploadFiles/nopic.gif';"/></td>
              </tr>
              <tr>
