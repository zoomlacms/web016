<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.page.Shop.AddProduct, App_Web_hlqfda2h" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
元</td>
                    ...
                    <tbody id="Tabs4" style="display: none">
                        ...
                        <tbody id="Tabs5" style="display: none"><tr class="tdbg">
                            ...
                            <td class="style2"><asp:TextBox ID="UpdateTime" runat="server" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" /> 
