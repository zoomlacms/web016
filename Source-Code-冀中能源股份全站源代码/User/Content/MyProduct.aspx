<%@ page language="C#" autoeventwireup="true" inherits="User_Content_MyProduct, App_Web_mvwzqnrx" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<body>
    <div class="us_pynews">
        <div class="us_seta">
            <asp:Label ID="lblAddContent" runat="server" Text="Label"></asp:Label> <a href="Myproduct.aspx?NodeID=<%=Request["NodeID"]%>&recycle=1">回收站</a>
        </div>
    </div>
    <div class="us_pynews">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            ...
                            <%--      <asp:LinkButton ID="DeleteBtn" runat="server" CommandName="Delete" CommandArgument='<%# Eval("ID") %>' Visible='<%#GetIsRe(Eval("Recycler", "{0}")) %>'
                                OnClientClick="return confirm('你确定将该数据彻底删除？')"> 彻底删除 </asp:LinkButton><a href='/User/Content/Myproduct.aspx?NodeID=2&method=Del&ID=<%# Eval("ID") %>' >删除</a>
                                 <a href='/User/Content/Myproduct.aspx?NodeID=2&method=Del&ID=<%# Eval("ID") %>' >还原</a>
                                 <a href='/User/Content/Myproduct.aspx?NodeID=2&method=Delete&ID=<%# Eval("ID") %>' >彻底删除</a>--%>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                </Columns>
