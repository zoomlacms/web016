<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.User.Shop.AddProduct, App_Web_mvwzqnrx" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
                                ...
                                <div id="TG">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="ColonelStartTimetxt" runat="server" OnFocus="setday(this)" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" CssClass="l_input"></asp:TextBox>
                                            </td>
                                            <td>
                                                结束时间:
                                            </td>
                                            <td>
                                                <asp:TextBox ID="ColonelendTimetxt" runat="server" OnFocus="setday(this)" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" CssClass="l_input"></asp:TextBox>
