<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="ZoomLa.WebSite.User.Content.EditContentpage, App_Web_mvwzqnrx" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>更新内容</title>
...
<form id="form1" runat="server">
		<ul class="us_seta" style="margin-top:10px;">
            ...
            <li style="width:70%;line-height:30px">
            <asp:TextBox ID="txtTitle" runat="server" Text='' Width="35%"  ></asp:TextBox>
...
<ul>
    <li style="width: 70%; float: left; line-height: 30px; text-align: right">
        ...
        <asp:TextBox ID="FilePicPath" runat="server" Text="fbangd" Style="display: none" />
        <asp:Button ID="EBtnSubmit" Text="修改" OnClick="EBtnSubmit_Click" runat="server" />
