<%@ page language="C#" autoeventwireup="true" inherits="User_PreViewOrder, App_Web_umfx2esq" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<link type="text/css" href="../App_Themes/UserThem/bidding.css" rel="stylesheet" />
<style type="text/css">
#flotop{width: 100%;}
...
#bDiv{display: none;position: absolute;top: 0px;left: 0px;right: 0px;background-color: #777;filter: progid:DXImageTransform.Microsoft.Alpha(style=3, opacity=25, finishOpacity=75);}
...
<form id="form1" runat="server">
    ...
    <div class="us_topinfo" style="margin-top: 10px;">
        ...
        <a href="PreViewOrder.aspx?menu=Orderinfo&type=4">成交订单</a>
        <a href="PreViewOrder.aspx?menu=Orderinfo&type=5">作废订单</a>
        ...
        <input type="text"  id="orderNum" style="color:#666;width:200px;" value="<%=s %>" 
                ...
                <ItemTemplate>
                    <ul>
                        <li style="width: 14%; float: left; line-height: 28px; text-align: left; white-space: nowrap;
                            overflow: hidden"><a href="?menu=ViewOrderlist&id=<%#Eval("id") %>&ordid=<%#Eval("OrderNo")%>">
                                <%#Eval("OrderNo")%></a> </li>
            ...
            <div runat="server" id="userorderproview" visible="false">
                ...
                <ul>
                    ...
                    <li style="width: 98.5%; float: none; line-height: 24px; text-align: left; background-color: #F7F7F7">
                     ...
                     <asp:LinkButton runat="server" ID="ULB_Track" Text="查看快递详细信息>>" Visible="false" onclick="ULB_Track_Click"></asp:LinkButton> 

                    </li>
                    
                </ul>
                 <div id="UOrders" visible="false" runat="server"><iframe src="http://api.kuaidi100.com/api?id=<%=KDKey %>&com=<%=Company %>&nu=<%=txtlabel11 %>&show=2&muti=1" width='550' height='310' scrolling='no' frameborder='0'></iframe></div>
    ...
    <div id="bgDiv"></div>
        ...
        <div id="cotainer" style="display:none;text-align:right;">
            <a href="javascript:easyDialog.close();" title="关闭窗口"><img src="../App_Themes/AdminDefaultTheme/PromptSkin/images/close.gif" /></a><br />
            <iframe id="queryIF" src="#" width='550' height='310' scrolling='no' frameborder='0' ></iframe>
        </div>
</div>
</form>
<script type="text/javascript">
