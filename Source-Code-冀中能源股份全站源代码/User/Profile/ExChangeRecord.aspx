<%@ page language="C#" autoeventwireup="true" inherits="User_Profile_ExChangeRecord, App_Web_tkuvo50o" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>兑换记录</title>
...
您现在的位置：<a title="网站首页" href="/" target="_parent"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label> </a>&gt;&gt; <a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx" )%>' target="_parent">会员中心</a>&gt;&gt;<a href="ExChangeRecord.aspx">兑换记录</a>&nbsp;
    ...
    <div align="center" class="us_seta"> 
      <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
        <tr class="tdbg">
          <th align="center" width="20%" height="25">申请时间</th>
