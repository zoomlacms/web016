<%@ page language="C#" autoeventwireup="true" inherits="User_Message_Mobile, App_Web_crrs1qcd" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
        ...
        <td><table id="TblAddMessage" width="100%" visible="true" runat="server">
            <tr>
              ...
              <%--(多条信息发送以半角逗号区隔，最多支持100个/次超100个请自行做循环)--%>一次只能发给一个号码一条短信
                <asp:RegularExpressionValidator ControlToValidate="TxtInceptUser" runat="server"  ValidationExpression="^(1(([35][0-9])|(47)|[8][012356789]))\d{8}$" >手机号码有误，请重新输入！</asp:RegularExpressionValidator>
