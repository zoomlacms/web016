<%@ page language="C#" autoeventwireup="true" inherits="User_Guest_MyApproval, App_Web_1wcy4dws" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
<a title="会员中心" href="/User/Default.aspx" target="_parent">会员中心</a> &gt;&gt; 我的赞同
</div>
            ...
            <asp:Repeater ID="Rep_comment" runat="server" OnItemDataBound="Rep_comment_ItemDataBound">
				<ItemTemplate>
					<tr onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" class="tdbg">
						<td style="width:40%; padding-left:10px; line-height:22px;"><label runat="server" id="lbAsk"></label></td>
						<td style="width:40%; padding-left:10px;"><label runat="server" id="lbAsw"></label></td>
						<td><%#Eval("AddTime") %></td>
					</tr>
				</ItemTemplate>
			</asp:Repeater>
