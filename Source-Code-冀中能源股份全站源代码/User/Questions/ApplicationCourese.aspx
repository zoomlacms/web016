<%@ page language="C#" autoeventwireup="true" inherits="User_Questions_ApplicationCourese, App_Web_4qknv0xv" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
<title>申请课程</title>
...
您现在的位置：<a title="网站首页" href="/" target="_blank"><asp:Label ID="LblSiteName" runat="server" Text=""></asp:Label></a>&gt;&gt; <a title="会员中心" href="/User/Default.aspx" target="_parent">会员中心</a> &gt;&gt; <a href="ApplicationCourese.aspx">申请课程</a>
  ...
  <div class="s_body" style="width: 100%">
    ...
    <h1 align="center"> 申请课程</h1>
      ...
      <asp:GridView ID="gvCard" runat="server" AutoGenerateColumns="False"  border="0" cellspacing="1"  AllowSorting="False" EnableTheming="False" Width="100%" RowStyle-CssClass='tdbg' HeaderStyle-Height="28px" EnableModelValidation="True">
