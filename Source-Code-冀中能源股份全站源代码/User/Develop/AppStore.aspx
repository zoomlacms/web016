<%@ page language="C#" autoeventwireup="true" inherits="User_Develop_AppStore, App_Web_jvucqquj" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
<title>应用商城</title>
...
<div id="app_mshop">
    <asp:DataList ID="appList" runat="server" RepeatColumns="7" 
        ...
        <ItemTemplate>
            <span><a href="<%# DataBinder.Eval(Container.DataItem, "Img") %>" title="<%# DataBinder.Eval(Container.DataItem, "Alias") %>"  class="lightbox" ><div style="text-align: center;"><img alt="<%# DataBinder.Eval(Container.DataItem, "Alias") %>" src="<%# DataBinder.Eval(Container.DataItem, "Img") %>" /></div> 
