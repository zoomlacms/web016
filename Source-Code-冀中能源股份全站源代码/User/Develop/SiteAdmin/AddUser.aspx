<%@ page language="C#" autoeventwireup="true" inherits="User_Develop_SiteAdmin_AddUser, App_Web_rrmvwnvm" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
    ...
    <div class="r_navigation">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" >
                ...
                <td style="width: 35%; height: 22px" align="left">
                    <asp:TextBox ID="tbBirthday" runat="server" onblur="setday(this);" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" class="l_input"></asp:TextBox>
                </td>
                <td class="tdbgleft" style="width: 15%; height: 22px" align="right">
                    办公电话：
                </td>
