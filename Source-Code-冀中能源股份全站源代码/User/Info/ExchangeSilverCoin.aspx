<%@ page language="C#" autoeventwireup="true" inherits="User_Info_ExchangeSilverCoin, App_Web_t0fqtia0" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
<title>兑换银币</title>
  ...
  <table style="width: 100%; margin: 0 auto;" cellpadding="0" cellspacing="0" class="border">
    ...
    <tr class="tdbg">
      ...
      <td style="width:80%;line-height:30px">&nbsp; &nbsp;&nbsp;将积分余额：
         <asp:TextBox ID="TxtExp" runat="server" Width="20" onKeyUp="value=value.replace(/[^\d\.]/g,'')" ></asp:TextBox>分兑换成银币&nbsp;&nbsp;兑换比率：<asp:Label ID="LblExpRate" runat="server" Text=""></asp:Label>
      </td>
    </tr>
    <tr class="tdbgbottom">
