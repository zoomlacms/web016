<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.UserInfo, App_Web_ukb3klby" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<tr class="tdbg" style="width:100%">
    ...
    <tr class="tdbg" style="width:100%">
    <td style="width:200px; float:left;line-height:30px; text-align:right">推荐人：</td>
    <td style=" line-height:30px" colspan="3"><asp:Label ID="LblParentUserID" runat="server"  Text=""></asp:Label></td>
</tr>
<tr class="tdbg"  style="width:100%">
<td style="width:100%; margin-top:5px; text-align:center" colspan="4">
    ...
    <input id="Button15" type="button"  value="赠送资金"  class="i_bottom"  onclick="javascript:location.href='PostPurse.aspx'" />&nbsp;       
    <input id="Button16" type="button"  value="赠送银币"  class="i_bottom"  onclick="javascript:location.href='PostCoin.aspx'" />&nbsp;       
    <input id="Button14" type="button"  value="赠送积分"  class="i_bottom"  onclick="javascript:location.href='PostPoint.aspx'" />&nbsp;       
</td>                   
</tr> 
</table>
</div>
