<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.UserBase, App_Web_ukb3klby" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<link href="../../JS/DatePicker/DateTheme/WdatePicker.css" type="text/css" rel="stylesheet" />
<link href="/Plugins/Ckeditor/EditFile/sample.css" type="text/css" rel="stylesheet" />
    ...
    <div class="us_seta" style="margin-top: 10px; width: 100%; float: left" id="manageinfo"
        ...
        <table style="width: 100%; margin: 0 auto;" cellpadding="0" cellspacing="0" class="border">
            ...
            <tr>
                ...
                <td style="line-height: 30px">
                    <asp:TextBox ID="tbBirthday" runat="server" onfocus="WdatePicker();" onclick="WdatePicker();"></asp:TextBox>
                </td>
                <td style="float: left; line-height: 30px; text-align: right">
                    办公电话：
                </td>
            ...
            <tr>
                ...
                <td style="line-height: 30px">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" ControlToValidate="tbHomePhone"
                        ErrorMessage="请输入区位号-数字！" Display="Dynamic" ValidationExpression="^\d+-(\d+)?$"></asp:RegularExpressionValidator>
                </td>
                <td style="float: left; line-height: 30px; text-align: right">
                    传真：
                </td>
            ...
            <tr>
                ...
                <td style="line-height: 30px">
                    <asp:DropDownList ID="tbProvince" runat="server" AutoPostBack="true" OnSelectedIndexChanged="tbProvince_SelectedIndexChanged"></asp:DropDownList>
                    <asp:DropDownList ID="tbCity" runat="server"></asp:DropDownList>
                    <asp:TextBox ID="tbCounty" runat="server" MaxLength="40"></asp:TextBox>
            ...
            <tr>
                ...
                <td style="float: left; line-height: 30px; text-align: right">公司名:</td>
                    <td style="line-height: 30px"><asp:TextBox runat="server" ID="CompanyName"></asp:TextBox></td>
            ...
            <tr>
                <td style="float: left; line-height: 30px; text-align: right">职务:</td>
                <td style="line-height: 30px"> 
                     <asp:TextBox runat="server" ID="Position"></asp:TextBox></td>
            ...
            <tr>
                ...
                <td style="line-height: 30px">
                    <div style="float:left;"><asp:Image ID="face" runat="server" Height="111" Width="111" ImageUrl="~/Images/userface/noface.gif" /></div>
         ...
         <asp:Button ID="btnSave" runat="server" Text="更新信息" Width="90px" OnClick="btnSave_Click"  TabIndex="12" />
