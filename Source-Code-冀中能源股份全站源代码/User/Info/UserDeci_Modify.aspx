<%@ page language="C#" autoeventwireup="true" inherits="User_Info_UserDeci_Modify, App_Web_t0fqtia0" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>编辑地址薄</title>
<link href="../../App_Themes/UserThem/user_user.css" rel="stylesheet" type="text/css" /><link rel="stylesheet" type="text/css" href="../../App_Themes/UserThem/bidding.css" /><link href="../../App_Themes/AdminDefaultTheme/main.css" type="text/css" rel="stylesheet" /> 
...
<table width="100%" cellpadding="2" cellspacing="1">
    ...
    <tr>
        <td colspan="2" align="center">
            <asp:Button ID="Button1" CssClass="i_bottom" runat="server" Text="添加" OnClick="Button1_Click" />&nbsp;
            <asp:Button ID="Button2" CssClass="i_bottom" runat="server" Text="取消"  OnClientClick="javascript:location.href='UserRecei.aspx';return false;" CausesValidation="False" />
        </td>
    </tr>
</table>
</form>
