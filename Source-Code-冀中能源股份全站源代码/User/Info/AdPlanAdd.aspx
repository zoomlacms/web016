<%@ page language="C#" autoeventwireup="true" inherits="User_Info_AdPlanAdd, App_Web_t0fqtia0" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="us_topinfo">您现在的位置：<a title="网站首页" href="/" target="_blank"><asp:Label ID="LblSiteName" runat="server" Text=""></asp:Label></a> &gt;&gt;<a title="会员中心" href="/User/Default.aspx" target="_parent">会员中心</a> &gt;&gt;<a title="修改密码" href="AdPlan.aspx">广告计划</a>&nbsp; 申请广告 </div>
  <div class="us_seta" id="AddMain" runat="server">
    ...
    <table width="100%" cellpadding="2" cellspacing="1" class="ad_info">
      <tr>
        ...
        <td>
  <div id="nocontent" runat="server" style="color:#f00;" visible="false">无版位信息</div><asp:RadioButtonList ID="ADID" runat="server" DataSourceID="RedioDataSource" DataTextField="ZoneName" DataValueField="ZoneID" RepeatDirection="Horizontal"> </asp:RadioButtonList>
      ...
      <tr>
        ...
        <td class="style1"><span id="Span2">
          <asp:TextBox ID="Ptime" class="input_out" runat="server" Width="200px" onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd' })"></asp:TextBox>
