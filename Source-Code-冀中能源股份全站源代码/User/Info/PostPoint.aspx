<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.PostPoint, App_Web_t0fqtia0" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
    <title>赠送积分</title>
...
您现在的位置：<a title="网站首页" href="#" target="_parent"><asp:Label ID="LblSiteName" runat="server" Text="Label"></asp:Label></a>&gt;&gt; <a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx" )%>' target="_parent">会员中心</a> &gt;&gt; <a href="UserInfo.aspx">账户管理</a>&gt;&gt;赠送积分 【<a href="PostPointP.aspx">使用佣金赠送积分</a>】
</div>
