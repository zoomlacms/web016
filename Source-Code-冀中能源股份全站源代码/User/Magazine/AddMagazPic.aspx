<%@ page language="C#" autoeventwireup="true" inherits="User_Magazine_AddMagazPic, App_Web_c21ofrb1" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html >
<head runat="server">
<title>创建电子杂志</title>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
     ...
     <tr>
       ...
       <td><asp:TextBox ID="musicurl" runat="server" class="l_input" Width="220px" Text="http://"></asp:TextBox>输入网络上mp3、wma文件地址。</td>
    </tr>
     <tr>
