<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="user_iServer_AddQuestion, App_Web_xb2cg0p3" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>提交问题</title>
...
<table width="100%">
                                        ...
                                        <table width="100%" cellpadding="21" cellspacing="1" class="border" style="background-color: white;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="tdbg" id="iframeHtml">
                                                    <textarea runat="server" id="textarea1" class="ckeditor" name="content" rows="4" style="width:715px;height:300px;"
    ...
    <script type="text/javascript">
        ...
        'rowspacingtop', 'rowspacingbottom', 'lineheight', '|',
         ...
         'link', 'unlink', 'anchor', '|', 'template', 'horizontal', 'date', 'time', '|', 'spechars', 'inserttable', 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', '|', 'print', 'preview', 'searchreplace', '|', 'help']]
        });
</script> 
</form>
</body>
