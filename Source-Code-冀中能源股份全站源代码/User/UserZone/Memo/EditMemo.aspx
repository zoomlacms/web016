<%@ page language="C#" autoeventwireup="true" inherits="EditMemo, App_Web_mrgjupnm" enableEventValidation="false" viewStateEncryptionMode="Never" %>
			...
			<td align="center">
				<table border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td align="left">
							<asp:TextBox ID="txtTime" runat="server" onfocus="setday(this)" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });"></asp:TextBox>
