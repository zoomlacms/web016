<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.GatherStrainManage.GSBuid, App_Web_v3wpza5g" title="族群" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="4">
	<tr>
		<td rowspan="5" style="width: 59px">
			...
			<label id="lab1" runat="server"  Visible="false"><asp:TextBox ID="txtpic" runat="server" Width="300px" /><br />
		...
		<td>
           ...
           <asp:LinkButton runat="server" ID="LK_rename" ForeColor="Red" 
                onclick="LK_rename_Click1" >修改</asp:LinkButton>
	...
	<tr>
		<td style="width: 527px">
            ...
            <asp:TextBox ID="TB_Info" runat="server"   Visible="false"  ></asp:TextBox>
		</td>
	</tr>
</table>
