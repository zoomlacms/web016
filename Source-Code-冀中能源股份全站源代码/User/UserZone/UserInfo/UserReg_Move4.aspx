<%@ page language="C#" autoeventwireup="true" inherits="UserReg_Move4, App_Web_l51jckle" enableEventValidation="false" viewStateEncryptionMode="Never" %>
          ...
          <td valign="top"><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td colspan="2" align="center"><table>
                    ...
                    <tr><td >   
                        <div id="viewid" runat="server"><object id="paizhao" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0"
...
</object></div>  <div id="fileUp" runat="server"><input id="File1" runat="server" type="file" />
                        &nbsp;&nbsp;
                        <asp:Button ID="Button1" runat="server" Text="上 传" OnClick="Button1_Click" /></div> 
                         <asp:Button ID="pzBtn" Text="拍照"  runat="server" OnClick="pzBtn_Click" /> 
                       <asp:Button ID="scBtn" Text="上传" runat="server" OnClick="scBtn_Click" /> 
              ...
              <tr>
                <td align="center"><table>
                    ...
                    <tr>
                      <td align="center"><asp:Image ID="imgPic1" ImageUrl="~/Images/nopic.gif" Width="225" Height="160px" runat="server" /></td>
                    </tr>
                    <tr>
                ...
                <td align="center"><table>
                    ...
                    <tr>
                      <td align="center"><asp:Image ID="imgPic2" Width="225" ImageUrl="~/Images/nopic.gif" Height="160px" runat="server" /></td>
                    </tr>
                    <tr>
              ...
              <tr>
                <td align="center"><table>
                    ...
                    <tr>
                      <td align="center"><asp:Image ID="imgPic3" ImageUrl="~/Images/nopic.gif" Width="225" Height="160px"  runat="server" /></td>
                    </tr>
                    <tr>
                ...
                <td align="center"><table>
                    ...
                    <tr>
                      <td align="center"><asp:Image ID="imgPic4" ImageUrl="~/Images/nopic.gif" Width="225" Height="160px" runat="server" /></td>
                    </tr>
                    <tr>
