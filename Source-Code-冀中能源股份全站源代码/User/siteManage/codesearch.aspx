<%@ page language="C#" autoeventwireup="true" inherits="User_siteManage_codesearch, App_Web_l0i3kelk" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>自定义搜索框</title>
...
<script language="javascript">
    function SelectColor(t, clientId) {
        var url = "<%=CustomerPageAction.customPath2%>Common/SelectColor.aspx?d=f&t=6";
