<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.User_Register, App_Web_umfx2esq" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html lang="zh-CN">
<head>
...
<link href="../JS/DatePicker/DateTheme/WdatePicker.css" rel="stylesheet" type="text/css"/>
...
<style type="text/css">
#apDiv1{position: absolute;	width: 106px;height: 16px;z-index: 1;top: 991px;left: 166px;}
.tdbgleft { text-align:right;}
.emptyDiv{height:auto;}
#userinfo {margin-left:260px; margin-top:10px; margin-bottom:200px; width:430px;}
#userinfo li{ text-align:left;}
#userinfo li span {color:#f00;}
</style>
</head>
<body>
...
<div class="reg">
    <h1> <asp:Literal ID="Literal3" runat="server" Text="第二步："></asp:Literal>填写会员信息<img alt="" src="../App_Themes/UserThem/images/regl2.gif" /></h1> 
    <div class="reg_sub">
        <div class="reg_title">
            创建您的帐号</div>
        <ul>
            ...
            <li>
                <div class="reg_put"> 
                        <asp:TextBox ID="TxtPassword" TextMode="Password" runat="server" CssClass="input_out"
                            onfocus="this.className='input_on';this.onmouseout=''; focusinput();" onblur="this.className='input_off';document.getElementById('valPass').style.display='none';this.onmouseout=function(){this.className='input_out'};"  onmousemove="this.className='input_move'" onmouseout="this.className='input_out'" Style="float: left;width:148px;"></asp:TextBox> 
                    <div id="valPass" style="width: 100px; height: 30px; display: none; float: left; margin-left: 10px;">
            ...
            <li>
                <div class="reg_put">
                    <asp:TextBox ID="TxtPwdConfirm" TextMode="Password" runat="server" CssClass="input_out"
                        ...
                        onmousemove="this.className='input_move'" onmouseout="this.className='input_out'" Style="width:148px;"></asp:TextBox>
        ...
        <ul>
            <li>
                <div class="reg_put">
                    <asp:DropDownList ID="DropDownList1" runat="server" CssClass="input_out" style="height:24px; padding:0px;">
                ...
                <div class="reg_put">
                    <table style="border-collapse: collapse; display: none;" id="TableRegisterSelect"
                        ...
                        <tr id="trSwicthSelectFill" runat="server" onmouseover="this.className='tdbgmouseover'"
                            ...
                            <td style="width: 20%" class="tdbgleft" onclick="SwicthSelectFill()">
                            </td>
                            <td>
                            </td>
                        </tr>
                    ...
                    <table style="border-collapse: collapse" cellspacing="1" cellpadding="2" width="100%"
                        border="0">
                        <tr class="tdbgleft" style="width: 20%" align="center" onmouseover="this.className='tdbgmouseover'"
                            onmouseout="this.className='tdbg'">
                            <td style="height: 30px;">
                                <span style="color: #ff0000">以上所有信息除选填项都必须先正确填写后才能成功注册。</span>
                            </td>
                        </tr>
                        <tr class="tdbgleft" style="width: 20%" align="center">
                            <td style="height: 30px;">
