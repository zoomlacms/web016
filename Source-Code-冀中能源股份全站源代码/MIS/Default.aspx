<%@ page language="C#" autoeventwireup="true" inherits="MIS_Default, App_Web_q3tnipkm" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
...
<div id="header" style="position:inherit;">
    ...
    <li><a href="javascript:ShowMain('','/user/Usertalk/TalkIndex.aspx');" id="hd0" ><img src="/App_Themes/UserThem/images/Mis/j_ico_comm.png" alt="沟通" /><br />沟通</a></li>
    <li><a href="javascript:ShowMain('','/Mis/Target/');" id="hd1"><img src="/App_Themes/UserThem/images/Mis/j_ico_pline.png" alt="目标" /><br />目标</a></li>
    <li><a href="javascript:ShowMain('','/Mis/Daily/');" id="hd2"><img src="/App_Themes/UserThem/images/Mis/j_ico_log.png" alt="日志" /><br />日志</a></li>
    <li><a href="javascript:ShowMain('','/Mis/Memo/');" id="hd3"><img src="/App_Themes/UserThem/images/Mis/j_ico_memo.png" alt="备忘" /><br />备忘</a></li>
    <li><a href="javascript:ShowMain('','/Mis/Plan/');" id="hd4"><img src="/App_Themes/UserThem/images/Mis/j_ico_plan.png" alt="计划" /><br />计划</a></li>
    <li><a href="javascript:ShowMain('','/Mis/Task/');" id="hd5"><img src="/App_Themes/UserThem/images/Mis/j_ico_task.png" alt="任务" /><br />任务</a></li>
    <li><a href="javascript:ShowMain('','/Mis/Project/');" id="hd6"><img src="/App_Themes/UserThem/images/Mis/j_ico_project.png" alt="项目" /><br />项目</a></li>
    <li><a href="javascript:ShowMain('','/Mis/Approval/');" id="hd7"><img src="/App_Themes/UserThem/images/Mis/j_ico_approve.png" alt="审批" /><br />审批</a></li>
