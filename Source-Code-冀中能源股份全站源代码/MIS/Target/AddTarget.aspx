<%@ page language="C#" autoeventwireup="true" inherits="MIS_AddMis, App_Web_01fcgh3y" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
                ...
                <table width="100%"  class="border"  >
                 <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                  ...
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="EndDate" SetFocusOnError="false" ErrorMessage="完成时间不能为空" ></asp:RequiredFieldValidator>
                    ...
                    <td>
                        <asp:TextBox id="TxtContent1" name="TxtContent1" width="580px" height="350px" TextMode="MultiLine" runat="server">
                        </asp:TextBox>
                        <script type="text/javascript">
                            var editor = UE.getEditor('TxtContent1')
                        </script>
                     </td>
                  </tr>
                      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
