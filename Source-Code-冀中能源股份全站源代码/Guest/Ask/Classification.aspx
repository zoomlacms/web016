<%@ page language="C#" autoeventwireup="true" inherits="Guest_AddClassification, App_Web_w42fsqsg" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
...
<div id="main_ask_l">
    ...
    <div class="classifynav" style="margin-top:0px;">
        <span class="cspan"><%=catename %><%=getCateCount() %></span>
        <ul class="cul">
